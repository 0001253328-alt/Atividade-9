programa {
  ...
  escreva("Digite o valor de matriz[0][2]: ")
  leia(matriz[0][2])
  ...
  escreva("Digite o valor de matriz[1][2]: ")
  leia(matriz[1][2])

  escreva("Digite o valor de matriz[2][0]: ")
  leia(matriz[2][0])

  escreva("Digite o valor de matriz[2][1]: ")
  leia(matriz[2][1])

  escreva("Digite o valor de matriz[2][2]: ")
  leia(matriz[2][2])
